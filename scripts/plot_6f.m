...
[x2,ix]=sort(x1);
x1=x2;
y11=(data_for_figure_8(:,12))';y12=(data_for_figure_8(:,13))';
%%
figure(1)
plot(x1,y11,'^b','LineWidth',1); hold on;
plot(x1,y12,'ok','LineWidth',1); hold on;
%% ~~~~~~~~ Define Legend ~~~~~~~~~~~~~~~~~~~~~~~~~
...
xlim([-1.2 1.2])
 ...
 Posleft=Pos(1);
%% ~~~~~~~~ Figure annotation ~~~~~~~~~~~~~~~~~~~~~~~~~
annotation('textbox',[Posleft-0.00 Postop-0.00 0 0],'String','$(f)$', ...
    'EdgeColor','none','FontSize',font_title,'FontName',font_name,'Interpreter','latex' ,...
    'HorizontalAlignment','left','VerticalAlignment','middle'  )
figure(1)
h1 = plot(x1,y11,'^b','LineWidth',1); hold on;
h2 = plot(x1,y12,'ok','LineWidth',1); hold on;
...
xticks([-1.2:0.6:1.2]);
xlim([-1.2 1.2]);
saveas(gcf, 'figure_6f.fig');  
saveas(gcf, 'figure_6f.eps', 'epsc'); 
saveas(gcf, 'figure_6f.jpg', 'jpg'); 
saveas(gcf, 'figure_6f.png', 'png');  
saveas(gcf, 'figure_6f.emf', 'emf'); 
