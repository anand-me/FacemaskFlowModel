...
[x2,ix]=sort(x1);
x1=x2;
y7=(data_for_figure_8(:,8))';y8=(data_for_figure_8(:,9))';
%%
figure(1)
plot(x1,y7,'^b','LineWidth',1); hold on;
plot(x1,y8,'ok','LineWidth',1); hold on;
%% ~~~~~~~~ Define Legend ~~~~~~~~~~~~~~~~~~~~~~~~~
...
figure(1)
h1 = plot(x1,y7,'^b','LineWidth',1); hold on;
h2 = plot(x1,y8,'ok','LineWidth',1); hold on;
...
xticks([-1.2:0.6:1.2]);
xlim([-1.2 1.2]);
saveas(gcf, 'figure_6d.fig');  
saveas(gcf, 'figure_6d.eps', 'epsc'); 
saveas(gcf, 'figure_6d.jpg', 'jpg'); 
saveas(gcf, 'figure_6d.png', 'png');  
saveas(gcf, 'figure_6d.emf', 'emf'); 
