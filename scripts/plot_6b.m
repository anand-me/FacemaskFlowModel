...
[x2,ix]=sort(x1);
x1=x2;
y3=(data_for_figure_8(:,4))';y4=(data_for_figure_8(:,5))';
%%
figure(1)
plot(x1,y3,'^b','LineWidth',1); hold on;
plot(x1,y4,'ok','LineWidth',1); hold on;
%% ~~~~~~~~ Define Legend ~~~~~~~~~~~~~~~~~~~~~~~~~
...
figure(1)
h1 = plot(x1,y3,'^b','LineWidth',1); hold on;
h2 = plot(x1,y4,'ok','LineWidth',1); hold on;
...
xticks([-1.2:0.6:1.2]);
xlim([-1.2 1.2]);
saveas(gcf, 'figure_6b.fig');  
saveas(gcf, 'figure_6b.eps', 'epsc'); 
saveas(gcf, 'figure_6b.jpg', 'jpg'); 
saveas(gcf, 'figure_6b.png', 'png');  
saveas(gcf, 'figure_6b.emf', 'emf'); 
